...
Khi lặp qua các iterator, ta lấy từng minibatch cho đến đến khi đã lấy hết bộ dữ liệu.
...
Mỗi lần cập nhật, ta tính gradient (đạo hàm đa chiều) của hàm mất mát theo các tham số. 
