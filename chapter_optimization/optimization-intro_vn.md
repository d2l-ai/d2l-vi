...
sau đó có thể sử dụng một thuật toán tối ưu nhằm cực tiểu hoá hàm mất mát đó.
...
Trong :numref:`sec_model_selection`, ta đã thảo luận chi tiết về sự khác nhau giữa các mục đích trên.
