...
2. Quá trình hội tụ thay đổi như thế nào nếu bạn thay đổi thừa số giảm trong tốc độ học? Để thuận tiện, hãy sử dụng `PolyScheduler` trong các thí nghiệm của bạn.
