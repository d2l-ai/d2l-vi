...
Có thể thấy, SGD tốn nhiều thời gian hơn để đạt được cùng giá trị mất mát như GD vì thuật toán này tính toán gradient trên từng mẫu một. <!--câu `mặc dù SGD hội tụ nhanh hơn GD về số mẫu được xử lý` cứ sai sai.-->
