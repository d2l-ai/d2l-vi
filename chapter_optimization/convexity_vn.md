...
Nó khiến chúng ta giải quyết các bài toán dưới dạng:
...
Lưu ý rằng bất kỳ ràng buộc nào không chủ động (quả banh không đụng đến bức tường) thì sẽ không thể tác động bất kỳ một lực nào lên quả banh.
...
Các biến  $\alpha_i$ ở đây được gọi là *nhân tử Lagrange*, chúng đảm bảo rằng các ràng buộc sẽ được thực thi đúng.
