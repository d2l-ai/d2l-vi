...
Trong những trường hợp này, thường sẽ dễ hơn khi thay vào đó biểu diễn mô hình dưới ngôn ngữ xác suất. 
Cho trước một mẫu $\mathbf{x}$, mô hình của chúng ta gán một xác suất $\hat{y}_k$ cho mỗi nhãn $k$.
