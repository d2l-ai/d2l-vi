...
Vì vậy, hiện tượng các vòng phản hồi (_feedback loop_) luẩn quẩn có thể sảy ra: Hệ thống gợi ý đẩy lên một sản phẩm và cho rằng sản phẩm này tốt hơn (do được mua nhiều hơn) từ đó sản phẩm này lại được hệ thống gợi ý thường xuyên hơn nữa.
