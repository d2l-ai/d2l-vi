...
Ký hiệu mục tiêu là $y_i$ (tương ứng với mẫu $\mathbf{x_i}$) và tập tất cả các mục tiêu là $\mathbf{y}$.
...
Bạn cũng có thể giả sử rằng có một mức cơ bản và người thợ sau đó tính tiền theo giờ.
