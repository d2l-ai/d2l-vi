...
Do đó ta muốn có cơ chế để lưu trữ những thông tin ban đầu quan trọng trong *ô nhớ*.
Nếu không, ta phải gán một giá trị gradient cực lớn cho quan sát ban đầu, vì nó ảnh hưởng đến toàn bộ các quan sát tiếp theo.
* Một tình huống khác là một vài ký hiệu không chứa thông tin phù hợp.
...
Trong chương này, ta sẽ bắt đầu với GRU do đơn giản hơn.
...
Tương tự như vậy, ta sẽ học để bỏ qua những quan sát tạm thời không liên quan, cũng như để xóa trạng thái ẩn khi cần.
...
Nếu tất cả các phần tử của cổng xóa $\mathbf{R}_t$ gần với $0$, ta sẽ có Perceptron đa tầng với $\mathbf{X}_t$ làm đầu vào.
Bất kỳ trạng thái ẩn nào tồn tại trước đó đều được đặt lại về giá trị mặc định.
Điều này dẫn đến *trạng thái ẩn tiềm năng* sau đây (chỉ là *tiềm năng* vì ta vẫn cần kết hợp đầu ra của cổng cập nhật).
...
Những thiết kế trên có thể giúp chúng ta giải quyết vấn đề tiêu biến gradient trong các mạng RNN và nắm bắt những phụ thuộc xa trong chuỗi thời gian tốt hơn.
