...
* LSTM có ba loại cổng kiểm soát luồng thông tin: cổng đầu vào, cổng quên và cổng đầu ra.
...
3. So sánh chi phí tính toán của GRU, LSTM và RNN thông thường cho cùng một chiều ẩn. Đặc biệt chú ý đến chi phí huấn luyện và dự đoán.
