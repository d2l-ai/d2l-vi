...
Khi kiểm tra, ta phóng ảnh về kích thước 256 pixel cả hai chiều, sau đó cắt ở vùng trung tâm để thu được ảnh có chiều dài và rộng là 224 pixel để làm đầu vào cho mô hình.
