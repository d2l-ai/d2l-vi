...
Cho đến giờ, các mô hình mà ta đã thảo luận là các lựa chọn phù hợp nếu bạn đang xử lý dữ liệu *dạng bảng*, tức dữ liệu bao gồm các hàng tương ứng với các mẫu còn các cột tương ứng với các đặc trưng.
...
Trong những trường hợp này, thứ tốt nhất ta có thể làm thường là sử dụng một perceptron đa tầng.
...
Ta sẽ trở lại với ví dụ phân biệt chó và mèo quen thuộc.
