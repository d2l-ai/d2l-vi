...
Vì chúng ta thường sử dụng các bộ lọc nhỏ với bất kỳ một lớp chập nào đã cho thì ta có thể chỉ mất một ít điểm ảnh, tuy nhiên sự mất mát  này có thể tích lũy dần khi ta thực hiện qua nhiều lớp mạng tích chập liên tiếp.
