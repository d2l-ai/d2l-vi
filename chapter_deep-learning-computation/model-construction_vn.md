...
Nhớ rằng một nơ-ron đơn lẻ (i) nhận một số đầu vào; (ii) tạo ra một đầu ra tương ứng (*vô hướng*); và (iii) có một tập các tham số liên quan có thể được cập nhật để tối ưu một số hàm mục tiêu mà ta quan tâm.
