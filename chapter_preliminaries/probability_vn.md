...
Bây giờ chúng ta có thể áp dụng quy tắc xác suất toàn phần và tích
...
-->
Do đó, lần kiểm ra thứ hai mang lại sự tự tin nhiều hơn cho chúng ta rằng không phải tất cả đều tốt. Mặc dù lần kiểm tra thứ hai kém chính xác hơn lần đầu, nhưng vẫn rất quan trọng trong việc cải thiện dự đoán.
