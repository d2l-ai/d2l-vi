...
* Mặc dù có vẻ như chỉ có thêm một vài dòng trong cách lập trình của AlexNet so với LeNet, nhưng cộng đồng học thuật đã phải mất nhiều năm để đón nhận sự thay đổi khái niệm này và tận dụng kết quả thực nghiệm tuyệt vời của nó. Điều này cũng là do việc thiếu các công cụ tính toán hiệu quả.
