...
3. Đưa dữ liệu qua một bộ trích chọn đặc trưng tiêu chuẩn như [SIFT](https://en.wikipedia.org/wiki/Scale-invariant_feature_transform), hoặc [SURF](https://en.wikipedia.org/wiki/Speeded_up_robust_features), hay bất kỳ một piplines điều chỉnh thủ công nào khác. 
4. Đưa các kết quả biểu diễn vào bộ phân loại mà ta ưa thích, có thể là một mô hình tuyến tính hoặc phương pháp kernel, để huấn luyện bộ phân loại. 
