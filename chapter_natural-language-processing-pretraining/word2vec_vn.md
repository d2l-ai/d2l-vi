...
Khác biệt lớn nhất là mô hình CBOW giả định rằng từ đích trung tâm được tạo ra dựa trên các từ ngữ cảnh trước và sau nó trong một chuỗi văn bản.
Với cùng một chuỗi văn bản "the", "man", "loves", "his" và "son", trong đó "love" là từ đích trung tâm, với kích thước cửa sổ ngữ cảnh bằng 2,
