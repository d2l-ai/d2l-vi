...
* [-] 8. [Mạng nơ-ron Truy hồi](chapter_recurrent-neural-networks/index_vn.md)
    ...
    * [x] 8.4. [Mạng nơ-ron Truy hồi](chapter_recurrent-neural-networks/rnn_vn.md)
    * [x] 8.5. [Lập trình Mạng nơ-ron Truy hồi từ đầu](chapter_recurrent-neural-networks/rnn-scratch_vn.md)
    * [x] 8.6. [Cách lập trình súc tích Mạng nơ-ron Truy hồi](chapter_recurrent-neural-networks/rnn-gluon_vn.md)
...
* [ ] 9. [Mạng Truy hồi Hiện đại](chapter_recurrent-modern/index_vn.md)
    * [x] 9.1. [Nút Truy hồi có Cổng (GRU)](chapter_recurrent-modern/gru_vn.md)
    * [x] 9.2. [Bộ nhớ Ngắn hạn Dài (LSTM)](chapter_recurrent-modern/lstm_vn.md)
    * [-] 9.3. [Mạng nơ-ron Truy hồi sâu](chapter_recurrent-modern/deep-rnn_vn.md)
    ...
    * [-] 9.6. [Kiến trúc Mã hóa - Giải mã](chapter_recurrent-modern/encoder-decoder_vn.md)
    * [-] 9.7. [Chuỗi sang Chuỗi](chapter_recurrent-modern/seq2seq_vn.md)
    * [-] 9.8. [Tìm kiếm Beam](chapter_recurrent-modern/beam-search_vn.md)
* [ ] 10. [Cơ chế Tập trung](chapter_attention-mechanisms/index_vn.md)
    * [-] 10.1. [Cơ chế Tập trung](chapter_attention-mechanisms/attention_vn.md)
