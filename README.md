...
* [-] 3. [Mạng nơ-ron Tuyến tính](chapter_linear-networks/index_vn.md)
    ...
    * [x] 3.3. [Triển khai súc tích của Hồi quy Tuyến tính](chapter_linear-networks/linear-regression-gluon_vn.md)
    * [-] 3.4. [Hồi quy Softmax](chapter_linear-networks/softmax-regression_vn.md)
    * [-] 3.5. [Bộ dữ liệu Phân loại Ảnh (Fashion-MNIST)](chapter_linear-networks/fashion-mnist_vn.md)
    * [x] 3.6. [Lập trình Hồi quy Sofmax từ đầu](chapter_linear-networks/softmax-regression-scratch_vn.md)
    * [x] 3.7. [Triển khai súc tích của Hồi quy Softmax](chapter_linear-networks/softmax-regression-gluon_vn.md)
* [ ] 4. [Perceptrons Đa tầng](chapter_multilayer-perceptrons/index_vn.md)
    * [-] 4.1. [Perceptrons Đa tầng](chapter_multilayer-perceptrons/mlp_vn.md)
    * [-] 4.2. [Lập trình Perceptrons Đa tầng từ đầu](chapter_multilayer-perceptrons/mlp-scratch_vn.md)
    * [-] 4.3. [Triển khai súc tích của Perceptrons Đa tầng](chapter_multilayer-perceptrons/mlp-gluon_vn.md)
