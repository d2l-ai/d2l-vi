...
* [ ] 8. [Mạng nơ-ron Hồi tiếp](chapter_recurrent-neural-networks/index_vn.md)
    ...
    * [-] 8.4. [Mạng nơ-ron Hồi tiếp](chapter_recurrent-neural-networks/rnn_vn.md)
    * [-] 8.5. [Lập trình Mạng nơ-ron Hồi tiếp từ đầu](chapter_recurrent-neural-networks/rnn-scratch_vn.md)
    * [-] 8.6. [Cách lập trình súc tích Mạng nơ-ron Hồi tiếp](chapter_recurrent-neural-networks/rnn-gluon_vn.md)
    * [-] 8.7. [Backpropagation Through Time](chapter_recurrent-neural-networks/bptt_vn.md)
* [ ] 9. [Mạng Hồi tiếp Hiện đại](chapter_recurrent-modern/index_vn.md)
