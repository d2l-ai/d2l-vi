...
* [ ] 7. [Mạng nơ-ron Tích chập Hiện đại](chapter_convolutional-modern/index_vn.md)
    ...
    * [-] 7.5. [Chuẩn hoá theo Batch](chapter_convolutional-modern/batch-norm_vn.md)
    * [-] 7.6. [Mạng Thặng dư (ResNet)](chapter_convolutional-modern/resnet_vn.md)
    * [-] 7.7. [Mạng Tích chập Kết nối Dày đặc (DenseNet)](chapter_convolutional-modern/densenet_vn.md)
