...
class Timer(object):
    ...
    Defined in :numref:`sec_linear_regression`"""
    def __init__(self):
        self.times = []
        self.start()
...
def load_array(data_arrays, batch_size, is_train=True):
    ...
    Defined in :numref:`sec_linear_gluon`"""
...
class RNNModel(nn.Block):
    """Defined in :numref:`sec_rnn_gluon`"""
...
def masked_softmax(X, valid_len):
    """Defined in :numref:`sec_attention`"""
...
def resnet18(num_classes):
    ...
    Defined in :numref:`sec_multi_gpu_gluon`"""
...
class CTRDataset(gluon.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return feat + self.offsets, self.data[idx]['y']# Alias defined in config.ini
